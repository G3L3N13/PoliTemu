      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-3">
          <button
            type="button"
            onClick={handleNavigate}
            className="flex-1 bg-cyan-500 py-3 rounded-xl text-black font-bold text-center"
          ...
          <a
            ...
            className="flex-1 bg-gray-700 py-3 rounded-xl text-white font-bold flex items-center justify-center text-center"
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 bg-gray-600 py-3 rounded-xl text-white font-medium"
            style={{ pointerEvents: "auto" }}
          >
            Copiar enlace
          </button>
          ...
          <button
            onClick={onClose}
            className="flex-1 bg-gray-700 py-3 rounded-xl text-white font-bold"
            style={{ pointerEvents: "auto" }}
          >
            Cerrar
          </button>
